...
require (
	...
	github.com/ellogroup/ello-golang-aws v1.0.0
...
require (
	...
	github.com/ellogroup/ello-golang-ctx v1.0.1 // indirect
	github.com/ellogroup/ello-golang-metrics v1.0.0 // indirect
